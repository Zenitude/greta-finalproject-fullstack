...
/*  Creation of first rooms
    Création des premières chambres */
INSERT INTO `rooms`(
    number, designation, beds, 
    bathrooms, toiletes, childrooms, 
    sallons, terraces, price
) 
VALUES
(
    '101', 'La premiere', 1,
...
/*  Creation of the table : roomsbooked
    Création de la table : roomsbooked */
...
(
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `FK_Booked_Reservation` 
        FOREIGN KEY (`idReservationB`) 
        REFERENCES `reservationshotel` (`idReservation`),
    CONSTRAINT `FK_Booked_Room` 
        FOREIGN KEY (`idRoomB`) 
