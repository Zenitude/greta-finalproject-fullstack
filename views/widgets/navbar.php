    ...
    <nav class="w-100 bg-beige position- navbar navbar-expand-lg" >
        ...
        <div id="navMain" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav w-100 d-flex flex-row align-items-center justify-content-center">
                ...
                <li class="nav-item"><a href="index.php?page=home#home" class="nav-link fw-bold text-darkness mx-1">Home</a></li>
                <li class="nav-item"><a href="index.php?page=home#hotel" class="nav-link fw-bold text-darkness mx-1">Hôtel</a></li>
                <li class="nav-item"><a href="index.php?page=home#restaurant" class="nav-link fw-bold text-darkness mx-1">Restaurant</a></li>
                
                <!-- Afficher le menu de gestion uniquement si un administrateur est connecté -->
                <?php if(isset($_SESSION['typeAdmin'])): ?>
                    <li class="nav-item <?php echo $activeGestion; ?>">
                        <a href="index.php?page=administration&section=gestion" class="nav-link fw-bold text-darkness mx-1">Gestion</a>
                    </li>
                <?php endif; ?>
